...
public:
	...
	GSheetWriteInitializeGlobal(ClientContext &context, FunctionData &bind_data, const string &file_path);
	static unique_ptr<LocalFunctionData> GSheetWriteInitializeLocal(ExecutionContext &context,
	                                                                        FunctionData &bind_data_p);
	static void GSheetWriteSink(ExecutionContext &context, FunctionData &bind_data_p,
	                                    GlobalFunctionData &gstate, LocalFunctionData &lstate, DataChunk &input);
	static void GSheetWriteCombine(ExecutionContext &context, FunctionData &bind_data,
	                                       GlobalFunctionData &gstate, LocalFunctionData &lstate);
	static void GSheetWriteFinalize(ClientContext &context, FunctionData &bind_data,
